...
START TRANSACTION;
USE `hacktm`;
INSERT INTO `hacktm`.`services` (`id`, `name`) VALUES (1, 'Telefonie mobilă');
INSERT INTO `hacktm`.`services` (`id`, `name`) VALUES (2, 'Televiziune');
INSERT INTO `hacktm`.`services` (`id`, `name`) VALUES (3, 'Internet');
...
START TRANSACTION;
USE `hacktm`;
INSERT INTO `hacktm`.`scrapers` (`id`, `name`, `url`, `script_name`, `enabled`, `last_updated`, `error`) VALUES (DEFAULT, 'Telekom scraper', 'https://www.telekom.ro/tiles/block/onlineShopProductJson.jsp?targeter=OneSiteAbonamente&count=1&html=true', 'telekom/mbabon.py', 1, NULL, NULL);
...
START TRANSACTION;
USE `hacktm`;
INSERT INTO `hacktm`.`service_characteristics` (`id`, `name`, `type`, `services_id`, `alias`) VALUES (DEFAULT, 'Minute naționale', 'scalar', 1, 'mobil_min_nat');
INSERT INTO `hacktm`.`service_characteristics` (`id`, `name`, `type`, `services_id`, `alias`) VALUES (DEFAULT, 'Trafic date', 'scalar', 1, 'mobil_date');
INSERT INTO `hacktm`.`service_characteristics` (`id`, `name`, `type`, `services_id`, `alias`) VALUES (DEFAULT, 'SMS naționale', 'scalar', 1, 'mobil_sms_nat');
INSERT INTO `hacktm`.`service_characteristics` (`id`, `name`, `type`, `services_id`, `alias`) VALUES (DEFAULT, 'Minute internaționale', 'scalar', 1, 'mobil_min_internat');
INSERT INTO `hacktm`.`service_characteristics` (`id`, `name`, `type`, `services_id`, `alias`) VALUES (DEFAULT, 'Viteză download (Mbps)', 'scalar', 3, 'inet_down');
INSERT INTO `hacktm`.`service_characteristics` (`id`, `name`, `type`, `services_id`, `alias`) VALUES (DEFAULT, 'Viteză upload (Mbps)', 'scalar', 3, 'inet_up');
INSERT INTO `hacktm`.`service_characteristics` (`id`, `name`, `type`, `services_id`, `alias`) VALUES (DEFAULT, 'Router inclus', 'boolean', 3, 'inet_router');
INSERT INTO `hacktm`.`service_characteristics` (`id`, `name`, `type`, `services_id`, `alias`) VALUES (DEFAULT, 'Receiver inclus', 'boolean', 2, 'tv_rcvr');
INSERT INTO `hacktm`.`service_characteristics` (`id`, `name`, `type`, `services_id`, `alias`) VALUES (DEFAULT, 'Număr canale', 'scalar', 2, 'tv_nchan');
